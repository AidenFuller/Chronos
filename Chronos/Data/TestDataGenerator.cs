...
namespace Chronos.Data
{
    public class TestDataGenerator
    {
        ...
        public static void Setup(string connectionString)
        {
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP1140"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP2230"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP2240"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP3290"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP3320"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP3600"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP3850"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP3851A"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP3851B"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP4110"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP4140"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP4251"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP4252"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP4261"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6140"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6230"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6240"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6270"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6290"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6340"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6350"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6370"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6600"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("COMP6900"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            #endregion

            #region SENG CourseAvailability
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG1050"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG1110"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG1120"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG2250"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG2260"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG3130"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG3160"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG3400"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG4150"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG4160"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG4211B"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG4800A"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG4800B"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6050"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6051"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6140"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6150"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6160"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6210B"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6220"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6250"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6260"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6400"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6450"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("SENG6460"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            #endregion
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG2200"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG2300"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG2440"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG2500"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG3200"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG3300"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG3440"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG4200"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG4440"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG4500"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG4801A"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG4801B"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG6200"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG6400"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG6440"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG6441"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG6500"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ENGG6860"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            #endregion

            #region INFT CourseAvailability
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT1000"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT1150"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT2050"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT2051"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT2150"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT3007"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT3940"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT3960"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT4020"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT4030"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT4040"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT6009"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT6060"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT6201"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT6304"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT6800"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("INFT6900"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            #endregion

            #region ELEC CourseAvailability
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ELEC3500"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("ELEC1710"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("MATH1510"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            ...
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("MATH1110"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("MATH1120"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            #endregion

            #region Other CourseAvailability
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("PSYC6831"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("STAT2300"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("STAT1070"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("JAPN1110"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("JAPN1120"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("JAPN2501"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            db.CourseAvailabilities.Add(new Models.CourseAvailability() { CourseID = CourseID("JAPN2502"), Campus = AvailableCampus.Callaghan, Runtime = CourseRuntime.Semester1 });
            #endregion
